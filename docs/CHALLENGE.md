> **Preserved as received.** This is OPENLANE's original challenge README, kept
> verbatim so the brief this repo was built against stays readable next to the
> work. Two things it says are no longer true of this fork: the dataset now
> lives at [`public/data/vehicles.json`](../public/data/vehicles.json) so it can
> be fetched rather than bundled, and the repo README is now the project's own
> — see [`../README.md`](../README.md).

---

<p align="center">
  <img src="the_block_repo.png" alt="The Block challenge hero image" width="960" />
</p>
...
Build the **buyer side of a vehicle auction platform as a web or mobile application**. We've included a dataset of 200 vehicles in `data/vehicles.json`, each listed by a selling dealership.
...
The vehicle dataset is at `data/vehicles.json`. Each vehicle includes:
